...
```
Managed: `https://api.ofauth.com/v2/access`

Proxy: `https://api.ofauth.com/v2/access/proxy`
```
...
### Basic Request Structure (Managed)
...
const conversations = await fetch(
	"https://api.ofauth.com/v2/access/chats",
	{
		headers: {
			apikey: "YOUR_API_KEY",
			"x-connection-id": "conn_abc123"
...
const messages = await fetch(
	"https://api.ofauth.com/v2/access/chat/123/messages",
	{
		headers: {
			apikey: "YOUR_API_KEY",
			"x-connection-id": "conn_abc123"
...
Use `/v2/access/proxy/*` to hit any OnlyFans API route:

```javascript Any OF path via proxy
// Conversations
await fetch("https://api.ofauth.com/v2/access/proxy/chats/rooms", { headers })

// Messages in a room
await fetch("https://api.ofauth.com/v2/access/proxy/chats/rooms/123/messages", { headers })

// Users
await fetch("https://api.ofauth.com/v2/access/proxy/users/me", { headers })
```
	{
		headers: {
			apikey: "YOUR_API_KEY",
...
- **Pay as You Go**: 30 Access req/min with 50 request burst capacity
- **Starter**: Standard Access rate limits (60 Access req/min with 90 request burst capacity)
- **Launch**: 120 Access req/min with 200 request burst capacity
- **Scale**: No Access rate limits (OnlyFans limits still apply)
