...
<Check>
  You have a [connected OnlyFans account](/guides/how-to/connect-account) with a valid `connectionId`
</Check>
...
print("Queued message ID:", result["id"])
```
...
async function sendPromoToActiveSubscribers() {
  ...
  console.log("✅ Mass message queued!")
...
<CardGroup cols={2}>
  ...
  <Card title="Track Earnings" icon="chart-line" href="/use-cases/earnings">
    Monitor PPV revenue
  </Card>
</CardGroup>
