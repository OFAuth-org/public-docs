...
<Info>
	**Embed SDK**: The OFAuth Embed SDK provides a seamless popup experience for
	hosted authentication. Contact [support@ofauth.com](mailto:support@ofauth.com)
	for SDK access and integration documentation.
</Info>
