...
- **Current Rules**: Latest rules available to all users (no special permissions required)
- **Early Access**: Preview rules available with slight delay (requires `preview_rules` permission)  
- **Public Rules**: Older stable rules available to everyone (no permissions required)
