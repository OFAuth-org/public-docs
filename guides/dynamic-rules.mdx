...
<Warning>
	**Most integrations don't need Dynamic Rules.** If you're using the [Access API](/reference/access) or [TypeScript SDK](/sdk), request signing is handled automatically. Only read this guide if you're making direct requests to OnlyFans APIs.
</Warning>
...
<CardGroup cols={2}>
	<Card title="Use the Access API Instead" icon="rocket" href="/reference/access">
...
<CardGroup cols={3}>
	...
	<Card title="Connections" icon="user" href="/reference/connections">
