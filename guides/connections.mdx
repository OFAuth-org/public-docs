...
| Method | When to Use |
|--------|-------------|
| [`connection.created` webhook](/api-reference/realtime/overview) | **Recommended.** Server-side, reliable, includes full details |
...
<Tip>
Set up [Realtime webhooks](/api-reference/realtime/overview) to receive `connection.expired` events.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Realtime" icon="bell" href="/api-reference/realtime/overview">
