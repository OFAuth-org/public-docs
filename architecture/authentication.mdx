...
<Info>
	**Legacy Support**: If you're unable to provide the `x-platform-id` header immediately, the API will still work but with slightly higher latency. We strongly recommend including this header for best performance. (This behavior will be phased out in 2026.)
</Info>
