...
<Info>
	**Using Python, Go, PHP, or another language?** Use our [REST APIs](/api-reference/access/overview) directly - they work with any language that can make HTTP requests. This SDK documentation covers TypeScript/JavaScript only.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="REST API Guide" icon="globe" href="/api-reference/access/overview">
...
<Warning>
  **Ready for Production?** Review our [Integration Checklist](/getting-started/integration-checklist) for important deployment and security information. 
</Warning>
