...
<Warning>
  **Enterprise Feature**: The programmatic Link authentication methods documented on this page are part of [Enterprise Whitelabel](/enterprise/whitelabel) and require approval before use. Contact [support@ofauth.com](mailto:support@ofauth.com) to request access.
</Warning>
...
<Info>
  **For most applications**: Use [Hosted Mode](/guides/link/hosted) or [Link Embed](/guides/link/embed) instead. These provide excellent user experiences and are available immediately without approval.
</Info>
...
<ParamField path="options.mode" type="'whitelabel'" required>
  The session mode. Requires [Enterprise Whitelabel](/enterprise/whitelabel) approval.
</ParamField>
