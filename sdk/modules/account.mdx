...
The Account module (`sdk.account`) provides access to account information. Webhook configuration is managed through the [OFAuth Dashboard](https://app.ofauth.com/platform/developers/webhooks), not via API.
...
Webhooks are configured exclusively through the [OFAuth Dashboard](https://app.ofauth.com/platform/developers/webhooks). From the Settings page you can:
...
<Note>
  For more details on webhook delivery behavior and retry policies, see the [Webhooks guide](/reference/webhooks).
</Note>
