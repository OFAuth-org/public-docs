...
<Warning>
  **Approval Required**: Direct mode is part of [Enterprise Whitelabel](/advanced/whitelabel) and requires approval. Contact [support@ofauth.com](mailto:support@ofauth.com) with your use case before implementing.
</Warning>

<Card title="Enterprise Whitelabel" icon="building" href="/advanced/whitelabel">
