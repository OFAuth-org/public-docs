...
<Card title="Enterprise API Specification" icon="file-code" href="https://api-next.ofauth.com/openapi-link-enterprise.json">
  Full OpenAPI specification for enterprise whitelabel integrations
</Card>
