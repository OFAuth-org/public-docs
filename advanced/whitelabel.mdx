...
<Info>
  **Most applications don't need whitelabel mode.** Our [Hosted Mode](/guides/link#hosted-mode) and [Link Embed](/guides/link#embed-mode) provide excellent user experiences with minimal integration effort. Only pursue whitelabel if you have specific requirements that hosted solutions cannot meet.
</Info>
...
<CardGroup cols={2}>
  <Card title="Hosted Mode" icon="external-link" href="/guides/link#hosted-mode">
    Redirect-based authentication with minimal integration effort
  </Card>
  <Card title="Link Embed" icon="window" href="/guides/link#embed-mode">
