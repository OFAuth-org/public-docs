...
<CardGroup cols={2}>
  <Card title="I'm evaluating OFAuth" icon="magnifying-glass" href="/introduction/services">
...
<CardGroup cols={3}>
  ...
  <Card title="Account Management" icon="user-gear" href="/guides/account">
...
<CardGroup cols={2}>
  ...
  <Card title="Use Case Guides" icon="book" href="/guides/messaging">
