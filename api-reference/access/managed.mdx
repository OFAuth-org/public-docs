...
| `mediaItems` | array | No | Media IDs or upload references |
| `isPinned` | boolean | No | Pin to profile |
| `scheduledDate` | string | No | ISO date for scheduled posting |
| `isMarkdown` | boolean | No | Parse text as markdown (default: true) |
...
| `isMarkdown` | boolean | No | Parse as markdown (default: true) |
