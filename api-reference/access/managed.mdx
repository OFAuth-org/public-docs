...
`/v2/access/users/{userId}`, `/v2/access/posts`). They require the standard OFAuth `apikey` header plus either a Link connection ID or direct OnlyFans session headers.
