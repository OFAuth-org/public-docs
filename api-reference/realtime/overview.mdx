...
| Event | Trigger |
|-------|---------|
| OnlyFans events (beta) | Receive beta OnlyFans activity events through Realtime |

<Info>
OnlyFans Events are currently in beta. The documented event categories may expand over time as coverage grows.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="OnlyFans Events Beta" icon="flask" href="/api-reference/realtime/onlyfans-events">
    Overview of the beta OnlyFans event webhook
  </Card>
</CardGroup>
