...
The Connections API manages your connected OnlyFans accounts. Connections are created through [Link](/guides/link) and used with the [Access API](/api-reference/access/overview).
