...
<CardGroup cols={2}>
	...
	<Card title="Going to Production" icon="shield" href="/getting-started/production-considerations">
		Critical reliability and risk management before you launch
	</Card>
</CardGroup>
...
<Info>
	**Data access working?** You now have the core knowledge to build OnlyFans integrations. Check out the [Integration Guides](/guides/link/overview) for advanced features.
</Info>
