...
Check the [SDK documentation](/sdk) for TypeScript or use the REST API directly for other languages.
</Accordion>
...
<CardGroup cols={2}>
	<Card title="2-Minute Quickstart" icon="rocket" href="/quickstart">
		Get your first API call working fast
	</Card>
	<Card title="Use Cases" icon="boxes" href="/use-cases/messaging">
